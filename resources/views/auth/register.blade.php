                ...
                <div class="card p-sm-4 p-3 login-group border-0">
                    ...
                    <div class="card-body p-1">
                        <form method="post" action="{{ url('/register') }}" id="registerForm">
                            ...
                            <div class="form-group mb-4 login-group__sub-title position-relative">
                                ...
                                <input type="password"
                                       ...
                                       onkeypress="return avoidSpace(event)" required data-toggle="password">
                            ...
                            <div class="form-group mb-4 login-group__sub-title position-relative">
                                ...
                                <input type="password" name="password_confirmation"
                                       class="form-control login-group__input"
                                       placeholder="{{ __('messages.confirm_password') }}" data-toggle="password" id="password_confirmation"
