...
class Permission extends Model implements PermissionContract
{
    ...
    public static function create(array $attributes = [])
    {
        ...
        $permission = static::getPermission(['title' => $attributes['title'], 'guard_name' => $attributes['guard_name']]);

        if ($permission) {
            throw PermissionAlreadyExists::create($attributes['title'], $attributes['guard_name']);
        }
